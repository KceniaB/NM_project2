...
# Load the sessions
#df_sessions = pd.read_parquet(f'metadata/{SESSIONS_FNAME}.pqt')
df_sessions = pd.read_parquet(f'/home/kceniabougrova/Documents/NM_project_fromIBLserver/NM_project2/CQ_PosterSfN_DC/{SESSIONS_FNAME}.pqt') #KB
...
df_insertions = pd.read_csv('/home/kceniabougrova/Documents/NM_project_fromIBLserver/NM_project2/CQ_PosterSfN_DC/insertions_all.csv') #KB
...
df_responses = pd.DataFrame(responses).explode('response').reset_index(drop=True)
